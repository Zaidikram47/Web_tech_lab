...
<body class="bg-slate-900 h-screen flex items-center justify-center p-4 font-sans text-slate-200">
    ...
    <div
        ...
        <div class="text-center mb-10 mt-2">
            <h1 class="text-3xl font-extrabold text-white tracking-tight">Join the Network</h1>
            <p class="text-slate-400 mt-2 text-sm">Fill in your details to create an account.</p>
        </div>
        ...
        <div class="mt-8 pt-6 border-t border-slate-700/50 text-center">
            <p class="text-slate-400 text-sm">
                ...
                <a href="login.php" class="text-indigo-400 font-semibold hover:text-indigo-300 transition-colors">Log in
                    here</a>
            </p>
        </div>
    </div>
